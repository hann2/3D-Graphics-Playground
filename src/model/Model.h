...
class Model {
    public:
        ...
        void render_model();
    private:
        void add_uniform_h(std::string uniform_name, void * data, int channels, std::unordered_map<std::string, model_uniform_t> * map, size_t size);
        std::vector<model_attribute_t> attributes;
        std::vector<model_texture_t> textures;
        std::unordered_map<std::string, model_uniform_t> fmatrices;
        std::unordered_map<std::string, model_uniform_t> fvectors;
        std::unordered_map<std::string, model_uniform_t> iflags;
